		...
		<div class="widget-box">
			...
			<div class="widget-main">
				<form class="form-inline" id="searchform">
					<label>姓名</label>
					<input type="text" class="input-large" placeholder="姓名" name="fundDTO.pname"/>
					<label>身份证号码</label>
					<input type="text" class="input-large" placeholder="身份证号码" name="fundDTO.idno"/>
					<button type="button" class="btn btn-info btn-sm" onclick="javascript:onClik();">
						<i class="ace-icon fa fa-search bigger-110"></i>查询
					</button>
					<a href="<%=basePath%>downloadExcel.action?fileName=公积金" class="btn btn btn-sm">
			...
			jQuery(grid_selector).jqGrid({
				...
				subGridRowExpanded: function (subgridDivId, rowId) {
					...
					$("#" + subgridTableId).jqGrid({
						url : "<%=basePath%>page/html/content/query/queryFund.action",
						mtype : "POST", 
						datatype : "json",
						postData : {'fundDTO.gjjId': $(grid_selector).getCell(rowId,'gjjId')},
						autowidth:true,
						colNames : [ '所有人身份证号','所有人姓名','公积金账号','缴存基数','最后缴费期限','账户余额','单位名称','状态','开户日期','所属','建立日期'],
						colModel : [
							{name:'bidno',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'bname',width:'90px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'gjjaccount',width:'170px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'cardinal',width:'90px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'lasttime',width:'120px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'banlance',width:'90px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'unitname',width:'120px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'state',width:'50px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'begintime',width:'100px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'area',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'ctime',width:'100px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor}
						]
					});
				},
				url : "<%=basePath%>page/html/content/query/queryFunds.action",
				mtype : "POST", 
				datatype : "json",
				postData : formData,
				height : 321,
				...
				colModel : [
				    {name:'gjjId',width:'120px',hidden:true},
