		...
		<div class="widget-box">
			...
			<div class="widget-main">
				<form class="form-inline" id="searchform">
					<label>姓名</label>
					<input type="text" class="input-large" placeholder="姓名" name="burialDTO.pname"/>
					<label>身份证号码</label>
					<input type="text" class="input-large" placeholder="身份证号码" name="burialDTO.idno"/>
					<button type="button" class="btn btn-info btn-sm" onclick="javascript:onClik();">
						<i class="ace-icon fa fa-search bigger-110"></i>查询
					</button>
					<a href="<%=basePath%>downloadExcel.action?fileName=殡葬" class="btn btn btn-sm">
			...
			jQuery(grid_selector).jqGrid({
				...
				subGridRowExpanded: function (subgridDivId, rowId) {
					...
					$("#" + subgridTableId).jqGrid({
						url : "<%=basePath%>page/html/content/query/queryBurial.action",
						mtype : "POST", 
						datatype : "json",
						postData : {'burialDTO.bid': $(grid_selector).getCell(rowId,'BId')},
						autowidth:true,
						colNames : [ '区','街道','社区','殡葬身份证号','殡葬姓名','火化时间','建立日期'],
						colModel : [
							...
							{name:'bidno',width:'120px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'bname',width:'120px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'hhtime',width:'120px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'ctime',width:'120px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
						]
					});
				},
				url : "<%=basePath%>page/html/content/query/queryBurials.action",
				mtype : "POST", 
				datatype : "json",
				postData : formData,
				height : 321,
				...
				colModel : [
				    {name:'BId',width:'120px',hidden:true},
