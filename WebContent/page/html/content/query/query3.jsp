		...
		<div class="widget-box">
			...
			<div class="widget-main">
				<form class="form-inline" id="searchform">
					<label>姓名</label>
					<input type="text" class="input-large" placeholder="姓名" name="vehicleDTO.pname"/>
					<label>身份证号码</label>
					<input type="text" class="input-large" placeholder="身份证号码" name="vehicleDTO.idno"/>
					<button type="button" class="btn btn-info btn-sm" onclick="javascript:onClik();">
						<i class="ace-icon fa fa-search bigger-110"></i>查询
					</button>
					<a href="<%=basePath%>downloadExcel.action?fileName=驾管" class="btn btn btn-sm">
			...
			jQuery(grid_selector).jqGrid({
				...
				subGridRowExpanded: function (subgridDivId, rowId) {
					...
					$("#" + subgridTableId).jqGrid({
						url : "<%=basePath%>page/html/content/query/queryVehicle.action",
						mtype : "POST", 
						datatype : "json",
						postData : {'vehicleDTO.vid': $(grid_selector).getCell(rowId,'VId')},
						autowidth:true,
						colNames : [ '区','街道','社区','车牌号','品牌','发动机号','购置时间','类型','建立日期'],
						colModel : [
							...
							{name:'vehicalNo',width:'120px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'brand',width:'120px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'motoNo',width:'120px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'buytime',width:'250px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'vtype',width:'250px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
							{name:'ctime',width:'120px',formatter:"actionFormatter",cellattr: addCellAttr_bgcolor},
						]
					});
				},
				url : "<%=basePath%>page/html/content/query/queryVehicles.action",
				mtype : "POST", 
				datatype : "json",
				postData : formData,
				height : 321,
				...
				colModel : [
				    {name:'VId',width:'120px',hidden:true},
