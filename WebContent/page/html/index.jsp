		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
					<li class="">
						<a data-url="<%=basePath%>page/html/content/index.html" href="#<%=basePath%>page/html/content/index.html">
					...
					<li class="">
						...
						<ul class="submenu">
						<li class="">
								<a data-url="<%=basePath%>page/html/content/base/a.jsp" href="#<%=basePath%>page/html/content/base/a.jsp">
							<i class="menu-icon fa fa-tachometer"></i>
							<span class="menu-text"> Dashboard </span>
						</a>
							...
							<li class="">
								<a data-url="<%=basePath%>page/html/content/base/b.jsp" href="#<%=basePath%>page/html/content/base/b.jsp">
									<i class="menu-icon fa fa-caret-right"></i>
									FAQ
								</a>
