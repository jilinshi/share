...
/**
 * The persistent class for the CK_HOUSEPROPERTY database table.
 * 
 */
@Entity
@Table(name="CK_HOUSEPROPERTY")
@NamedQuery(name="CkHouseproperty.findAll", query="SELECT c FROM CkHouseproperty c")
public class CkHouseproperty implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="CK_HOUSEPROPERTY_FID_GENERATOR", sequenceName="SEQ")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="CK_HOUSEPROPERTY_FID_GENERATOR")
