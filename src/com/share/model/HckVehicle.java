...
/**
 * The persistent class for the HCK_VEHICLE database table.
 * 
 */
@Entity
@Table(name="HCK_VEHICLE")
@NamedQuery(name="HckVehicle.findAll", query="SELECT h FROM HckVehicle h")
public class HckVehicle implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private HckVehiclePK id;
	...
	public HckVehiclePK getId() {
		return this.id;
	}

	public void setId(HckVehiclePK id) {
		this.id = id;
	}
